...
if(pcscore == 5){
    ...
    stroke("white");
    textSize(25)
    text("☹☹ !Sorry But You Lose So It Is Game Over! ☹☹",width/2,height/2);
    text("Press The Reload Button Or Reload The Page",width/2,height/2+30)
    noLoop();
    pcscore = 0;
}
